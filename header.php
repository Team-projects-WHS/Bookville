<header class="header mt-1 mb-4">
    <div class="row">
      <nav class="navbar navbar-expand-lg">
        <div class="container-xl d-flex justify-content-between align-items-end header-border-bottom">
    ...
    <div class="container-xxl">
      <nav class="navbar navbar-expand-lg">
        <div class="container-xl d-flex justyfy-content-between flex-grow-1">
          <div class="collapse navbar-collapse">
            <div class="dropdown dropdown-section me-4">
              <button class="btn dropdown-toggle dropdown-toggle-down d-flex text-brown-1 p-left-0 active" type="button" id="dropdownSection"
                data-bs-toggle="dropdown" aria-expanded="false">
                <span class="d-block header-menu-icon d-inline-block align-top me-3 my-auto"></span>
                Подразделы
              </button>
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 justify-content-between flex-grow-1">
              <li class="nav-item me-2">
                <a class="nav-link text-brown-2" href="about.php">О нас</a>
              </li>
              <li class="nav-item me-2">
                <a class="nav-link text-brown-2">Мероприятия</a>
              </li>
              <li class="nav-item me-2">
                <a class="nav-link text-brown-2">Скидки</a>
              </li>
              <li class="nav-item me-2">
                <a class="nav-link text-brown-2" href="blog.php">Блог</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-brown-2 me-2">Доставка и оплата</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-brown-2">Контакты</a>
              </li>
            </ul>
          </div>
          <div class="collapse navbar-collapse justify-content-end">
            <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
              <li class="nav-item me-3">
                <a class="header-facebook" href="https://ru-ru.facebook.com">
                  <img src="img/header/facebook.svg" alt="facebook">
                </a>
              </li>
              <li class="nav-item me-4">
                <a class="header-instagram" href="https://www.instagram.com">
                  <img src="img/header/instagram.svg" alt="instagram">
                </a>
              </li>
              <li class="nav-item dropdown p-right-0">
                <button class="btn btn-menu-local dropdown-toggle dropdown-toggle-lang text-grey-2" type="button" id="lang"
                  data-bs-toggle="dropdown" aria-expanded="false">
                  RU
                </button>
